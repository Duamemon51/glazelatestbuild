...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold text-gray-800">Create New Pattern</h1>
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            <form method="POST" action="{{ route('admin.patterns.store') }}">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <textarea name="svg_content" id="svg_content" rows="20"
                              ...
                              placeholder="Paste your SVG code here..." required>{{ old('svg_content') }}</textarea>
                    @error('svg_content')
                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                ...
                <div class="mb-4">
                    ...
                    <div id="svg-preview" class="border rounded p-4 bg-gray-50 min-h-32 flex items-center justify-center">
                        <span class="text-gray-500">SVG preview will appear here</span>
                    </div>
                </div>
